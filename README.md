...
## Prerequisite
- Supported Nodejs 18 & higher versions
- All build command should be run on the root level
- package.json & sfraBuilderConfig.js files should be placed on the root level 
